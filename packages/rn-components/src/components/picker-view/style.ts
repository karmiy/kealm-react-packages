...
export const withPickerViewStyles = createStyles(({ theme, utils: { hairlineBorder }, px }) =>
    StyleSheet.create({
        ...
        container: {
            height: px(theme.c_picker_view_item_height * (DEFAULT_SIDE_COUNT * 2 + 1)), // 默认上下各 3 个
            backgroundColor: theme.c_picker_view_background_color,
        },
        scrollView: {
            flex: 1,
        ...
        content: {
            paddingVertical: px(theme.c_picker_view_item_height * DEFAULT_SIDE_COUNT),
        },
        itemText: {
            height: px(theme.c_picker_view_item_height),
            lineHeight: px(theme.c_picker_view_item_height),
            textAlign: 'center',
        ...
        indicator: {
            ...
            width: '100%',
            height: px(theme.c_picker_view_item_height),
            top: px(theme.c_picker_view_item_height * DEFAULT_SIDE_COUNT),
            left: 0,
        ...
        maskTop: {
            position: 'absolute',
            width: '100%',
            height: px(theme.c_picker_view_item_height * DEFAULT_SIDE_COUNT),
            top: 0,
            left: 0,
        },
        maskBottom: {
